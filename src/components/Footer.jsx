      ...
      <footer className="border-t border-slate-800 py-8 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-slate-500">
            ...
            <a href="https://www.facebook.com/jerwin.tugas.2024/" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.instagram.com/jerwinn.io/" target="_blank" rel="noopener noreferrer"
            ...
            <a href="mailto:tugasjerwin7@gmail.com"
              aria-label="Email" className="hover:text-white transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
